...
- **Interfaz Multimodal**:
  ...
  - **Voice**: Servidor dedicado para interacción por voz. Consulta [Denverclaw_Voice](https://github.com/lw9eau/Denverclaw_Voice) para la implementación con Atom Echo Client.
